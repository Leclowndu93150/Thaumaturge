...
public final class TCEntityEvents {
    ...
    public static void onAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(
                TCEntities.THAUMIC_SLIME.get(), ThaumicSlime.createAttributes().build());
        event.put(
        ...
        event.put(
                TCEntities.TAINT_SEED_PRIME.get(),
        ...
        event.put(
                TCEntities.CULTIST_PORTAL_LESSER.get(),
