...
public final class LogisticsGuiOpener {
    ...
    public static void open(Player player, @Nullable LogisticsTarget target) {
        ...
        serverPlayer.openMenu(
                new SimpleMenuProvider((containerId, inventory, menuPlayer) -> new MenuGolemLogistics(containerId, inventory, target), Component.translatable("gui.thaumaturge.logistics")), buf -> {
                });
    }
}
