...
public final class ResearchTextEn {
    ...
    private static void part0(BiConsumer<String, String> add) {
        ...
        add.accept(
                ...
                "§oMana Pod§r<IMG>thaumaturge:textures/research/research_manapod.png:0:0:128:128:.6</IMG>This strange, pod like plant is only found growing on trees in magical forests. They grow very slowly and when harvested usually only yield one or two beans.");
        add.accept(
                "research.thaumaturge.plants.addendum_6",
                "§oMana Beans§r<BR>These beans, known as Mana Beans, contain concentrated amounts of essentia. They can also be consumed, though the results are often a bit unpredictable.<BR>They can be replanted on the underside of logs within magical biomes, but cultivation is difficult and time-consuming.<BR>Wild mana pods usually only produce primal aspects, though it is said that pods growing adjacent to pods of differing aspects sometimes result in beans with compound aspects.<BR><BR><IMG>thaumaturge:textures/research/research1.png:0:240:64:16:1</IMG>");
        ...
        add.accept(
                ...
                "I have my wand, but now I need to craft the foci. The old scrolls aren't very clear on how to go about this, so I will need to find my own way.<BR>I have played with the idea of assembling a focus from crystals and then using vis to bind them together. My initial experiments have been failures... explosive failures.<BR>I think the answer I seek lies with an alchemical process.<BR>Using an ordo crystal as a core I might be able to leverage its ordered structure to grow a focus around it. While this is happening it should absorb praecantatio and auram essentia.<BR>The result should hopefully be a crystal focus able to absorb and manipulate vis. ");
        add.accept(
