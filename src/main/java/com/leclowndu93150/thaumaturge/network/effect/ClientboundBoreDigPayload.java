...
public record ClientboundBoreDigPayload(BlockPos target, int boreEntityId, BlockPos borePos, int delay) implements CustomPacketPayload {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ClientboundBoreDigPayload> STREAM_CODEC = StreamCodec.composite(BlockPos.STREAM_CODEC, ClientboundBoreDigPayload::target,
            ByteBufCodecs.VAR_INT, ClientboundBoreDigPayload::boreEntityId, BlockPos.STREAM_CODEC, ClientboundBoreDigPayload::borePos, ByteBufCodecs.VAR_INT, ClientboundBoreDigPayload::delay,
