...
public final class TCBlocks {
    ...
    public static final DeferredBlock<BlockTube> TUBE =
            BLOCKS.registerBlock("tube", BlockTube::new, TCBlocks::tubeProps);

    public static final DeferredBlock<BlockTubeValve> TUBE_VALVE =
            BLOCKS.registerBlock("tube_valve", BlockTubeValve::new, TCBlocks::tubeProps);

    public static final DeferredBlock<BlockTubeRestrict> TUBE_RESTRICT =
            BLOCKS.registerBlock("tube_restrict", BlockTubeRestrict::new, TCBlocks::tubeProps);

    public static final DeferredBlock<BlockTubeFilter> TUBE_FILTER =
            BLOCKS.registerBlock("tube_filter", BlockTubeFilter::new, TCBlocks::tubeProps);

    public static final DeferredBlock<BlockTubeOneway> TUBE_ONEWAY =
            BLOCKS.registerBlock("tube_oneway", BlockTubeOneway::new, TCBlocks::tubeProps);

    public static final DeferredBlock<BlockTubeBuffer> TUBE_BUFFER =
            BLOCKS.registerBlock("tube_buffer", BlockTubeBuffer::new, TCBlocks::tubeProps);
    ...
    public static final DeferredBlock<BlockFluxGoo> FLUX_GOO = BLOCKS.registerBlock(
            ...
            props -> props.mapColor(MapColor.COLOR_PINK)
                    .replaceable()
                    .noCollision()
                    .strength(100.0F)
    ...
    public static final DeferredBlock<BlockTaintRock> TAINT_ROCK =
            BLOCKS.registerBlock("taint_rock", BlockTaintRock::new, TCBlocks::taintBlockProps);

    public static final DeferredBlock<BlockTaintSoil> TAINT_SOIL =
            BLOCKS.registerBlock("taint_soil", BlockTaintSoil::new, TCBlocks::taintBlockProps);

    public static final DeferredBlock<BlockTaintCrust> TAINT_CRUST =
            BLOCKS.registerBlock("taint_crust", BlockTaintCrust::new, TCBlocks::taintBlockProps);

    public static final DeferredBlock<BlockTaintGeyser> TAINT_GEYSER =
            BLOCKS.registerBlock("taint_geyser", BlockTaintGeyser::new, TCBlocks::taintBlockProps);
    ...
    private static BlockBehaviour.Properties pressPlaceholderProps(BlockBehaviour.Properties props) {
        return props.mapColor(MapColor.STONE)
    ...
    private static BlockBehaviour.Properties amberProps(BlockBehaviour.Properties props) {
        return props.mapColor(MapColor.COLOR_ORANGE)
                .strength(0.5F)
                .sound(SoundType.STONE)
                .noOcclusion()
    ...
    private static BlockBehaviour.Properties taintBlockProps(BlockBehaviour.Properties props) {
        return props.mapColor(MapColor.COLOR_PURPLE)
    ...
    private static BlockBehaviour.Properties tubeProps(BlockBehaviour.Properties props) {
        return props.mapColor(MapColor.METAL)
                .strength(0.5F, 5.0F)
                .sound(SoundType.METAL)
                .noOcclusion();
    }
    ...
    public static final DeferredBlock<BlockRechargePedestal> RECHARGE_PEDESTAL =
            BLOCKS.registerBlock("recharge_pedestal", BlockRechargePedestal::new, TCBlocks::pedestalProps);
    ...
    public static final DeferredBlock<BlockPlaceholder> PLACEHOLDER_IRON_BARS =
            BLOCKS.registerBlock("placeholder_iron_bars", BlockPlaceholder::new, TCBlocks::pressPlaceholderProps);

    public static final DeferredBlock<BlockPlaceholder> PLACEHOLDER_CAULDRON =
            BLOCKS.registerBlock("placeholder_cauldron", BlockPlaceholder::new, TCBlocks::pressPlaceholderProps);

    public static final DeferredBlock<BlockPlaceholder> PLACEHOLDER_ANVIL =
            BLOCKS.registerBlock("placeholder_anvil", BlockPlaceholder::new, TCBlocks::pressPlaceholderProps);

    public static final DeferredBlock<BlockPlaceholder> PLACEHOLDER_TABLE =
            BLOCKS.registerBlock("placeholder_table", BlockPlaceholder::new, TCBlocks::pressPlaceholderProps);

    public static final DeferredBlock<BlockPedestal> PEDESTAL_ANCIENT =
            BLOCKS.registerBlock("pedestal_ancient", BlockPedestal::new, TCBlocks::pedestalProps);

    public static final DeferredBlock<BlockPedestal> PEDESTAL_ELDRITCH =
            BLOCKS.registerBlock("pedestal_eldritch", BlockPedestal::new, TCBlocks::pedestalProps);

    public static final DeferredBlock<BlockPillar> PILLAR_ARCANE =
            BLOCKS.registerBlock("pillar_arcane", BlockPillar::new, TCBlocks::pillarProps);

    public static final DeferredBlock<BlockPillar> PILLAR_ANCIENT =
            BLOCKS.registerBlock("pillar_ancient", BlockPillar::new, TCBlocks::pillarProps);

    public static final DeferredBlock<BlockPillar> PILLAR_ELDRITCH =
            BLOCKS.registerBlock("pillar_eldritch", BlockPillar::new, TCBlocks::pillarProps);

    public static final DeferredBlock<BlockStoneTC> STONE_ARCANE =
            BLOCKS.registerBlock("stone_arcane", props -> new BlockStoneTC(props, false), TCBlocks::stoneProps);

    public static final DeferredBlock<BlockStoneTC> STONE_ARCANE_BRICK =
            BLOCKS.registerBlock("stone_arcane_brick", props -> new BlockStoneTC(props, false), TCBlocks::stoneProps);

    public static final DeferredBlock<BlockStoneTC> STONE_ANCIENT =
            BLOCKS.registerBlock("stone_ancient", props -> new BlockStoneTC(props, false), TCBlocks::stoneProps);

    public static final DeferredBlock<BlockStoneTC> STONE_ANCIENT_TILE =
            BLOCKS.registerBlock("stone_ancient_tile", props -> new BlockStoneTC(props, false), TCBlocks::stoneProps);

    public static final DeferredBlock<BlockStoneTC> STONE_ANCIENT_ROCK = BLOCKS.registerBlock(
            "stone_ancient_rock", props -> new BlockStoneTC(props, true), TCBlocks::unbreakableProps);

    public static final DeferredBlock<BlockStoneTC> STONE_ANCIENT_GLYPHED = BLOCKS.registerBlock(
            "stone_ancient_glyphed", props -> new BlockStoneTC(props, false), TCBlocks::stoneProps);

    public static final DeferredBlock<BlockStoneTC> STONE_ANCIENT_DOORWAY = BLOCKS.registerBlock(
            "stone_ancient_doorway", props -> new BlockStoneTC(props, true), TCBlocks::unbreakableProps);

    public static final DeferredBlock<BlockStoneTC> STONE_ELDRITCH_TILE = BLOCKS.registerBlock(
            "stone_eldritch_tile", props -> new BlockStoneTC(props, false), TCBlocks::eldritchTileProps);

    public static final DeferredBlock<BlockStonePorous> STONE_POROUS =
            BLOCKS.registerBlock("stone_porous", BlockStonePorous::new, TCBlocks::porousProps);
    ...
    public static final DeferredBlock<BlockStoneTC> MATRIX_SPEED =
            BLOCKS.registerBlock("matrix_speed", props -> new BlockStoneTC(props, false), TCBlocks::stoneProps);

    public static final DeferredBlock<BlockStoneTC> MATRIX_COST =
            BLOCKS.registerBlock("matrix_cost", props -> new BlockStoneTC(props, false), TCBlocks::stoneProps);
    ...
    public static final DeferredBlock<BlockArcaneEar> ARCANE_EAR =
            BLOCKS.registerBlock("arcane_ear", props -> new BlockArcaneEar(false, props), TCBlocks::earProps);

    public static final DeferredBlock<BlockArcaneEar> ARCANE_EAR_TOGGLE =
            BLOCKS.registerBlock("arcane_ear_toggle", props -> new BlockArcaneEar(true, props), TCBlocks::earProps);

    public static final DeferredBlock<BlockLampArcane> LAMP_ARCANE =
            BLOCKS.registerBlock("lamp_arcane", BlockLampArcane::new, TCBlocks::lampProps);

    public static final DeferredBlock<BlockLampGrowth> LAMP_GROWTH =
            BLOCKS.registerBlock("lamp_growth", BlockLampGrowth::new, TCBlocks::lampProps);

    public static final DeferredBlock<BlockLampFertility> LAMP_FERTILITY =
            BLOCKS.registerBlock("lamp_fertility", BlockLampFertility::new, TCBlocks::lampProps);
    ...
    public static final DeferredBlock<BlockEssentiaPort> ESSENTIA_INPUT =
            BLOCKS.registerBlock("essentia_input", props -> new BlockEssentiaPort(true, props), TCBlocks::portProps);

    public static final DeferredBlock<BlockEssentiaPort> ESSENTIA_OUTPUT =
            BLOCKS.registerBlock("essentia_output", props -> new BlockEssentiaPort(false, props), TCBlocks::portProps);
    ...
    public static final DeferredBlock<BlockSaplingTC> SAPLING_GREATWOOD = BLOCKS.registerBlock(
            ...
            props -> props.mapColor(MapColor.PLANT)
                    .noCollision()
                    .randomTicks()
                    .instabreak()
    ...
    public static final DeferredBlock<UntintedParticleLeavesBlock> LEAVES_SILVERWOOD = BLOCKS.registerBlock(
            ...
            props -> new UntintedParticleLeavesBlock(
                    ...
                    ColorParticleOption.create(ParticleTypes.TINTED_LEAVES, SILVERWOOD_LEAF_PARTICLE_COLOR),
                    props),
    ...
    public static final DeferredBlock<BlockGrassAmbient> GRASS_AMBIENT = BLOCKS.registerBlock(
            ...
            props -> props.mapColor(MapColor.GRASS)
                    .strength(0.6F)
    ...
    public static final DeferredBlock<SlabBlock> SLAB_SILVERWOOD = BLOCKS.registerBlock(
            "slab_silverwood",
            SlabBlock::new,
            props -> props.mapColor(MapColor.QUARTZ)
                    .strength(1.0F, 2.0F)
                    .sound(SoundType.WOOD)
                    .ignitedByLava());
    ...
    public static final DeferredBlock<BlockAmber> AMBER_BRICK =
            BLOCKS.registerBlock("amber_brick", BlockAmber::new, TCBlocks::amberProps);
    ...
    public static final DeferredBlock<BlockEffectShock> EFFECT_SHOCK = BLOCKS.registerBlock(
            ...
            props -> props.mapColor(MapColor.COLOR_CYAN)
    ...
    public static final DeferredBlock<BlockAmber> AMBER_BLOCK =
            BLOCKS.registerBlock("amber_block", BlockAmber::new, TCBlocks::amberProps);
    ...
    private static DeferredBlock<BlockLoot> lootBlock(String id, BlockLoot.LootType type, boolean crate) {
        return BLOCKS.registerBlock(
                ...
                props -> props.mapColor(crate ? MapColor.WOOD : MapColor.STONE)
                        .strength(0.15F, 0.0F)
