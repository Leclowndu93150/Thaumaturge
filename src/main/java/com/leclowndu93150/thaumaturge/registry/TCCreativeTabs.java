...
public final class TCCreativeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, TCIds.MODID);

    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> THAUMATURGE = CREATIVE_MODE_TABS.register("thaumaturge",
            () -> CreativeModeTab.builder().title(Component.translatable("itemGroup.thaumaturge")).icon(() -> new ItemStack(TCItems.THAUMONOMICON.get())).displayItems((parameters, output) -> {
