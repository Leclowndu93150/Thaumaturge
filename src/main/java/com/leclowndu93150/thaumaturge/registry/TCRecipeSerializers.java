...
public final class TCRecipeSerializers {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<DustTriggerSimpleRecipe>>
            DUST_TRIGGER_SIMPLE =
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<DustTriggerMultiblockRecipe>>
            DUST_TRIGGER_MULTIBLOCK = RECIPE_SERIALIZERS.register(
                    "dust_trigger_multiblock", () -> DustTriggerMultiblockRecipe.SERIALIZER);
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<InfusionEnchantmentRecipe>>
            INFUSION_ENCHANTMENT =
                    RECIPE_SERIALIZERS.register("infusion_enchantment", () -> InfusionEnchantmentRecipe.SERIALIZER);

    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<InfusionRunicAugmentRecipe>>
            RUNIC_AUGMENT = RECIPE_SERIALIZERS.register("runic_augment", () -> InfusionRunicAugmentRecipe.SERIALIZER);
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<ArcaneShapedCraftingRecipe>>
            ARCANE_SHAPED =
                    RECIPE_SERIALIZERS.register("arcane_workbench_shaped", () -> ArcaneShapedCraftingRecipe.SERIALIZER);

    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<ArcaneShapelessCraftingRecipe>>
            ARCANE_SHAPELESS = RECIPE_SERIALIZERS.register(
                    "arcane_workbench_shapeless", () -> ArcaneShapelessCraftingRecipe.SERIALIZER);
